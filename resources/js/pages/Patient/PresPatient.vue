    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="biller-info" style="background-color: aqua">
          ...
          <br />
          <br />
          <h4 class="d-block">Dr.{{ pres.signature }}</h4>
          ...
          <table class="table table-center">
            <thead>
              <tr>
                ...
                <th style="width: 100px">procédure d'utilisation</th>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <p>{{ pres.procedure_to_use_medicine }}</p>
                </td>
              </tr>
            </tbody>
          </table>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      this.axios
        .get(`http://localhost:8000/api/prescreption/${this.$route.params.id}`)
        .then((response) => {
